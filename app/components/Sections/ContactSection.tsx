              ...
              <CardBody className="p-6">
                ...
                <form onSubmit={handleCommentSubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    className="group/btn relative block h-14 w-full rounded-md bg-gradient-to-br from-blue-950 to-purple-700 font-medium text-white shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:bg-zinc-800 dark:from-zinc-900 dark:to-zinc-900 dark:shadow-[0px_1px_0px_0px_#27272a_inset,0px_-1px_0px_0px_#27272a_inset] font-poppins disabled:opacity-50 disabled:cursor-not-allowed"
                  >
